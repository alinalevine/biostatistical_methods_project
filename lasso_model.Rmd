...
```{r linear}
fit_1 = lm(target_death_rate ~ pct_bach_deg25_over + incidence_rate + pct_public_coverage_alone + poverty_percent + region_se + pct_unemployed16_over + birth_rate + pct_hs25_over + pct_hs18_24 + pct_married_households + race_other + pct_employed16_over, data = d)

summary(fit_1)

fit_2 = lm(target_death_rate ~ pct_bach_deg25_over + incidence_rate + pct_public_coverage_alone + poverty_percent + region_se + pct_unemployed16_over + birth_rate + pct_hs25_over + pct_hs18_24 + pct_married_households + race_other, data = d)

summary(fit_2)

fit_3 = lm(target_death_rate ~ pct_bach_deg25_over + incidence_rate + pct_public_coverage_alone + poverty_percent + region_se + pct_unemployed16_over + birth_rate + pct_hs25_over + pct_hs18_24 + pct_married_households, data = d)
